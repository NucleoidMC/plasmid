...
public final class ActiveGamePortalBackend implements GamePortalBackend {
    ...
    public ActiveGamePortalBackend( Text name, List<Text> description, ItemStack icon, GameSpaceManager manager, JoinIntent intent) {
        this.name = name;
    ...
    public void provideGameSpaces(Consumer<GameSpace> consumer) {
        this.manager.getOpenGameSpaces().forEach(consumer);
    }
